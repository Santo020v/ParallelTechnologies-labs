...
public class JournalMain {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread as1 = new Thread(new JournalThread(journal, "Assistant1"));
        Thread as2 = new Thread(new JournalThread(journal, "Assistant2"));
        Thread as3 = new Thread(new JournalThread(journal, "Assistant3"));
